...
if len(arguments) == 0:
    ...
    #print('  python $CANDLE/wrappers/templates/scripts/generate_hyperparameter_grid.py "[\'john\', np.arange(5,15,2)]" "[\'single_num\', [4]]" "[\'letter\', [\'x\',\'y\',\'z\']]" "[\'arr\', [[2,2],None,[2,2,2],[2,2,2,2]]]" "[\'smith\', np.arange(-1,1,0.2)]"')
    print('  python $CANDLE/wrappers/templates/scripts/generate_hyperparameter_grid.py "[\'john\',np.arange(5,15,2)]" "[\'single_num\',[4]]" "[\'letter\',[\'x\',\'y\',\'z\']]" "[\'arr\',[[2,2],None,[2,2,2],[2,2,2,2]]]" "[\'smith\',np.arange(-1,1,0.2)]"')
    print('')
    exit()
