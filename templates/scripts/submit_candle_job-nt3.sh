...
# Required variables
export MODEL_SCRIPT="$CANDLE_WRAPPERS/templates/models/nt3_baseline_keras2.py"
export DEFAULT_PARAMS_FILE="$CANDLE_WRAPPERS/templates/model_params/nt3_default_model.txt"
export WORKFLOW_SETTINGS_FILE="$CANDLE_WRAPPERS/templates/workflow_settings/bayesian_workflow-nt3.R"
export NGPUS=6
